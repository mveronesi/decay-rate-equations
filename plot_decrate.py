...
def plot_decrate(dm=17.757,dg=0.085,gs=0.664,
    ...
    # plotting options
    plot_B_f_t = B_f_t if (qt_plus and qf_plus) else False
    plot_Bbar_f_t = Bbar_f_t if (qt_min and qf_plus) else False
    plot_B_fbar_t = B_fbar_t if (qt_plus and qf_min) else False
    plot_Bbar_fbar_t = Bbar_fbar_t if (qt_min and qf_min) else False
