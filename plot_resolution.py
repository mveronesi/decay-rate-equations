...
def plot_resolution(sigma_t,a_acc,n_acc,b_acc,beta_acc,cutoff_acc,
    ...
    if fold_amix and (len(t_fold)>1):
        ...
        Amix_fbar_t_fold = Afold_qf(t=t_fold,qf=-1,dm=dm,dg=dg,gs=gs,r=r,delta=delta_rad,gamma=gamma_rad,beta=beta_rad,k=k,sigma_t=sigma_t) if (bbar_fbar or bbar_fbar) else False
        ...
        Amix_fbar_t = Amix_qf(t=t,qf=-1,dm=dm,dg=dg,gs=gs,r=r,delta=delta_rad,gamma=gamma_rad,beta=beta_rad,k=k,sigma_t=sigma_t) if (bbar_fbar or bbar_fbar) else False
