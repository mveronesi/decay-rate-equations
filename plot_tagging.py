...
def plot_tagging(omega,d_omega,eff,d_eff,
    ...
    B_f_obs_t = B_f_obs(t,dm,dg,gs,r,delta_rad,gamma_rad,beta_rad,a_acc,n_acc,b_acc,beta_acc,cutoff_acc,sigma_t,omega_b,omega_bar,eff_b,eff_bar)
    Bbar_f_obs_t = Bbar_f_obs(t,dm,dg,gs,r,delta_rad,gamma_rad,beta_rad,a_acc,n_acc,b_acc,beta_acc,cutoff_acc,sigma_t,omega_b,omega_bar,eff_b,eff_bar)
    B_fbar_obs_t = B_fbar_obs(t,dm,dg,gs,r,delta_rad,gamma_rad,beta_rad,a_acc,n_acc,b_acc,beta_acc,cutoff_acc,sigma_t,omega_b,omega_bar,eff_b,eff_bar)
    Bbar_fbar_obs_t = Bbar_fbar_obs(t,dm,dg,gs,r,delta_rad,gamma_rad,beta_rad,a_acc,n_acc,b_acc,beta_acc,cutoff_acc,sigma_t,omega_b,omega_bar,eff_b,eff_bar)
    ...
    Untag_f_t = Untagged_f_obs(t,dm,dg,gs,r,delta_rad,gamma_rad,beta_rad,a_acc,n_acc,b_acc,beta_acc,cutoff_acc,sigma_t,omega_b,omega_bar,eff_b,eff_bar)
    Untag_fbar_t = Untagged_fbar_obs(t,dm,dg,gs,r,delta_rad,gamma_rad,beta_rad,a_acc,n_acc,b_acc,beta_acc,cutoff_acc,sigma_t,omega_b,omega_bar,eff_b,eff_bar)
    ...
    Amix_f_obs_t_fold = Amix_f_obs_fold(t_fold,dm,dg,gs,r,delta_rad,gamma_rad,beta_rad,a_acc,n_acc,b_acc,beta_acc,cutoff_acc,sigma_t,omega_b,omega_bar,eff_b,eff_bar)
    Amix_fbar_obs_t_fold = Amix_fbar_obs_fold(t_fold,dm,dg,gs,r,delta_rad,gamma_rad,beta_rad,a_acc,n_acc,b_acc,beta_acc,cutoff_acc,sigma_t,omega_b,omega_bar,eff_b,eff_bar)
